...
namespace UnPeu.Controllers
{
    public class EventTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description,Color,Image")] EventType eventType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description,Color,Image")] EventType eventType)
        {
            if (ModelState.IsValid)
            {
